...
import { deleteGoalController } from "./useCases/Goal/DeleteGoal";
...
// DELETE route to delete a goal
router.delete("/goals", authMiddleware, (request, response, next) => {
	return deleteGoalController.handle(request, response, next);
});
